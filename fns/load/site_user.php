...
$higher_site_role_hierarchy = true;
...
if (isset($user[0])) {
    ...
    if (Registry::load('current_user')->site_role_attribute !== 'administrators') {
        if ((int)$user['role_hierarchy'] >= (int)Registry::load('current_user')->role_hierarchy) {
            $higher_site_role_hierarchy = false;
        }
    }
    ...
    if ((int)$user_id !== (int)Registry::load('current_user')->id) {
        ...
        if (role(['permissions' => ['site_users' => 'edit_users']]) && $higher_site_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
        ...
        if (role(['permissions' => ['site_users' => 'approve_users']]) && $higher_site_role_hierarchy) {
        ...
        if (role(['permissions' => ['site_users' => 'unban_users_from_site']]) && $higher_site_role_hierarchy) {
        ...
        if (role(['permissions' => ['site_users' => 'ban_users_from_site']]) && $higher_site_role_hierarchy) {
            if ($user['site_role_attribute'] !== 'banned_users') {
                $output['options'][$option_index] = new stdClass();
                $output['options'][$option_index]->class = 'ask_confirmation';
                $output['options'][$option_index]->attributes['data-update'] = 'site_user_role';
        ...
        if (role(['permissions' => ['site_users' => 'ban_ip_addresses']]) && $higher_site_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
        ...
        if (role(['permissions' => ['site_users' => 'unban_ip_addresses']]) && $higher_site_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
        ...
        if (role(['permissions' => ['site_users' => 'delete_users']]) && $higher_site_role_hierarchy) {
            $output['options'][$option_index] = new stdClass();
    ...
    if (role(['permissions' => ['site_users' => 'manage_user_access_logs']]) && $higher_site_role_hierarchy) {
        $output['options'][$option_index] = new stdClass();

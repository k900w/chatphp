...
<head>
    ...
    <title><?php echo Registry::load('strings')->under_mainteance_title.' - '.Registry::load('settings')->site_name; ?></title>
    <meta name="description" content="<?php echo Registry::load('strings')->under_mainteance_description; ?>">
